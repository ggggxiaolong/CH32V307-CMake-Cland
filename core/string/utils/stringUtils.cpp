...
std::tuple<int, int, int> StringUtils::disassemble_fstr(const char *str,
                                                        const size_t len) {
  int int_part = 0;
  int frac_part = 0;
  int scale = 1;
...
int StringUtils::kmp_find(char *src, const size_t src_len, const char *match,
...
void StringUtils::str_replace(char *src, const size_t src_len,
