...
void TIM_TimeBaseInit(TIM_TypeDef *TIMx, const TIM_TimeBaseInitTypeDef *TIM_TimeBaseInitStruct) {
    ...
    if ((TIMx == TIM1) || (TIMx == TIM2) || (TIMx == TIM3) || (TIMx == TIM4) || (TIMx == TIM5) || (TIMx == TIM8) || (TIMx == TIM9) ||
        (TIMx == TIM10)) {
...
void TIM_GenerateEvent(TIM_TypeDef *TIMx, uint16_t TIM_EventSource) { TIMx->SWEVGR = TIM_EventSource; }
 ...
 * @return  none
 */
void TIM_DMAConfig(TIM_TypeDef *TIMx, uint16_t TIM_DMABase, uint16_t TIM_DMABurstLength) { TIMx->DMACFGR = TIM_DMABase | TIM_DMABurstLength; }
 ...
 * @return  none
 */
void TIM_InternalClockConfig(TIM_TypeDef *TIMx) { TIMx->SMCFGR &= (uint16_t)(~((uint16_t)TIM_SMS)); }
 ...
 * @return  none
 */
void TIM_SetCounter(TIM_TypeDef *TIMx, uint16_t Counter) { TIMx->CNT = Counter; }
 ...
 * @return  none
 */
void TIM_SetAutoreload(TIM_TypeDef *TIMx, uint16_t Autoreload) { TIMx->ATRLR = Autoreload; }
 ...
 * @return  none
 */
void TIM_SetCompare1(TIM_TypeDef *TIMx, uint16_t Compare1) { TIMx->CH1CVR = Compare1; }
 ...
 * @return  none
 */
void TIM_SetCompare2(TIM_TypeDef *TIMx, uint16_t Compare2) { TIMx->CH2CVR = Compare2; }
 ...
 * @return  none
 */
void TIM_SetCompare3(TIM_TypeDef *TIMx, uint16_t Compare3) { TIMx->CH3CVR = Compare3; }
 ...
 * @return  none
 */
void TIM_SetCompare4(TIM_TypeDef *TIMx, uint16_t Compare4) { TIMx->CH4CVR = Compare4; }
 ...
 * @return  none
 */
void TIM_ClearFlag(TIM_TypeDef *TIMx, uint16_t TIM_FLAG) { TIMx->INTFR = (uint16_t)~TIM_FLAG; }
 ...
 * @return  none
 */
void TIM_ClearITPendingBit(TIM_TypeDef *TIMx, uint16_t TIM_IT) { TIMx->INTFR = (uint16_t)~TIM_IT; }
