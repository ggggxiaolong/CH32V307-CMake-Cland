...
#ifdef ENABLE_UART1
        case USART1_BASE:
            RCC_APB2PeriphClockCmd(RCC_APB2Periph_USART1, en.to_state());
            if (UART1_REMAP) {
...
#ifdef ENABLE_UART2
        case USART2_BASE:
            RCC_APB1PeriphClockCmd(RCC_APB1Periph_USART2, en.to_state());
            if (UART2_REMAP) {
...
#ifdef ENABLE_UART3
        case USART3_BASE:
            RCC_APB1PeriphClockCmd(RCC_APB1Periph_USART3, en.to_state());
            switch (UART3_REMAP) {
                case 1:
...
#ifdef ENABLE_UART4
        case UART4_BASE:
            RCC_APB1PeriphClockCmd(RCC_APB1Periph_UART4, en.to_state());
            switch (UART4_REMAP) {
                case 1:
...
#ifdef ENABLE_UART5
        case UART5_BASE:
            RCC_APB1PeriphClockCmd(RCC_APB1Periph_UART5, en.to_state());
            switch (UART4_REMAP) {
                case 1:
...
#ifdef ENABLE_UART6
        case UART6_BASE:
            RCC_APB1PeriphClockCmd(RCC_APB1Periph_UART6, en.to_state());
            switch (UART6_REMAP) {
                case 1:
...
#ifdef ENABLE_UART7
        case UART7_BASE:
            RCC_APB1PeriphClockCmd(RCC_APB1Periph_UART7, en.to_state());
...
#ifdef ENABLE_UART8
        case UART8_BASE:
            RCC_APB1PeriphClockCmd(RCC_APB1Periph_UART8, en.to_state());
            switch (UART8_REMAP) {
                case 1:
...
void UartHw::enable_single_line_mode(const Enable en) {
    USART_HalfDuplexCmd(instance_, en.to_state());
    if (en.to_state()) {
        txio().inpu();
    } else {
        txio().outod();
...
void UartHw::enable_rxne_it(const Enable en) {
    ...
    USART_ITConfig(instance_, USART_IT_RXNE, en.to_state());
}
